...
class PagerDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, minimum: 1 }, pageSize: { required: false, type: () => Number, minimum: 1, maximum: 100 }, field: { required: false, type: () => String }, order: { required: false, enum: require("./pager.dto").Order }, _t: { required: false, type: () => Number } };
    }
}
exports.PagerDto = PagerDto;
__decorate([
    (0, swagger_1.ApiProperty)({ minimum: 1, default: 1, description: '页码' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ minimum: 1, maximum: 100, default: 10, description: '每页数量' }),
    (0, class_validator_1.Min)(1),
