...
exports.uniqueSlash = exports.hashString = exports.randomValue = exports.generateRandomValue = exports.generateShortUUID = exports.generateUUID = exports.getAvatar = void 0;
const nanoid_1 = require("nanoid");
const crypto_util_1 = require("./crypto.util");
function getAvatar(mail) {
    if (!mail)
        return '';
    return `https://cravatar.cn/avatar/${(0, crypto_util_1.md5)(mail)}?d=retro`;
}
