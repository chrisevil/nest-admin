...
export declare function generateUUID(size?: number): string;
export declare function generateShortUUID(): string;
export declare function generateRandomValue(length: number, placeholder?: string): string;
export declare function randomValue(size?: number, dict?: string): string;
