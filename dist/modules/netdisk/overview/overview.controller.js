...
exports.NetDiskOverviewController = exports.permissions = void 0;
const openapi = require("@nestjs/swagger");
const cache_manager_1 = require("@nestjs/cache-manager");
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const permission_decorator_1 = require("../../auth/decorators/permission.decorator");
const overview_dto_1 = require("./overview.dto");
const overview_service_1 = require("./overview.service");
exports.permissions = (0, permission_decorator_1.definePermission)('netdisk:overview', {
    DESC: 'desc',
});
...
__decorate([
    (0, common_1.Get)('desc'),
    (0, cache_manager_1.CacheKey)('netdisk_overview_desc'),
    (0, cache_manager_1.CacheTTL)(3600),
    (0, common_1.UseInterceptors)(cache_manager_1.CacheInterceptor),
    (0, swagger_1.ApiOperation)({ summary: '获取网盘空间数据统计' }),
    (0, swagger_1.ApiOkResponse)({ type: overview_dto_1.OverviewSpaceInfo }),
    (0, permission_decorator_1.Perm)(exports.permissions.DESC),
    openapi.ApiResponse({ status: 200, type: require("./overview.dto").OverviewSpaceInfo }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], NetDiskOverviewController.prototype, "space", null);
exports.NetDiskOverviewController = NetDiskOverviewController = __decorate([
    (0, swagger_1.ApiTags)('NetDiskOverview - 网盘概览模块'),
