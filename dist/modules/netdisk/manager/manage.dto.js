...
exports.IsLegalNameExpression = IsLegalNameExpression = __decorate([
...
class FileOpItem {
    ...
    name;
    static _OPENAPI_METADATA_FACTORY() {
        return { type: { required: true, type: () => String, pattern: "/(^file$)|(^dir$)/" }, name: { required: true, type: () => String } };
    }
}
...
class GetFileListDto {
    ...
    key;
    static _OPENAPI_METADATA_FACTORY() {
        return { marker: { required: true, type: () => String }, path: { required: true, type: () => String }, key: { required: true, type: () => String } };
    }
}
...
class MKDirDto {
    ...
    path;
    static _OPENAPI_METADATA_FACTORY() {
        return { dirName: { required: true, type: () => String }, path: { required: true, type: () => String } };
    }
}
...
class RenameDto {
    ...
    path;
    static _OPENAPI_METADATA_FACTORY() {
        return { type: { required: true, type: () => String, pattern: "/(^file$)|(^dir$)/" }, toName: { required: true, type: () => String }, name: { required: true, type: () => String }, path: { required: true, type: () => String } };
    }
}
...
class FileInfoDto {
    ...
    path;
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, path: { required: true, type: () => String } };
    }
}
...
class DeleteDto {
    ...
    path;
    static _OPENAPI_METADATA_FACTORY() {
        return { files: { required: true, type: () => [require("./manage.dto").FileOpItem] }, path: { required: true, type: () => String } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.ArrayMaxSize)(oss_constant_1.NETDISK_HANDLE_MAX_ITEM),
...
class MarkFileDto {
    ...
    mark;
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, path: { required: true, type: () => String }, mark: { required: true, type: () => String } };
    }
}
...
class FileOpDto {
    ...
    toPath;
    static _OPENAPI_METADATA_FACTORY() {
        return { files: { required: true, type: () => [require("./manage.dto").FileOpItem] }, originPath: { required: true, type: () => String }, toPath: { required: true, type: () => String } };
    }
}
