...
exports.TodoQueryDto = exports.TodoUpdateDto = exports.TodoDto = void 0;
...
class TodoUpdateDto extends (0, swagger_1.PartialType)(TodoDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return {};
    }
}
exports.TodoUpdateDto = TodoUpdateDto;
class TodoQueryDto extends (0, swagger_1.IntersectionType)(pager_dto_1.PagerDto, TodoDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return {};
    }
}
